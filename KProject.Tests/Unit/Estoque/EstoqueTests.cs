...
namespace KProject.Tests.Unit.Estoque;

public class EstoqueTests
{
    private static Domain.Estoque.Estoque CriaEstoque() => Domain.Estoque.Estoque.Criar(1).Value;
    ...
    {
        var result = Domain.Estoque.Estoque.Criar(loteId, 10);
    ...
    {
        var result = Domain.Estoque.Estoque.Criar(1);
    ...
    {
        var result = Domain.Estoque.Estoque.Criar(1, 10);
